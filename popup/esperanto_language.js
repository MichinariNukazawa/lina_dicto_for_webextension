...
-------------------------------------------------------------------------
   ...
   Tiu c^i vortareto estas la posteulo de "Elektronika Baza Vortaro 
Esperanto-Japana", kiu aperis en la jaro 1996 kun c^. 4700 kapvortoj.
G^i nun enhavas c^. 44 100 kapvortojn.   Mi planas, ke g^i kresku g^is 
la amplekso de c^. 50 000 kapvortoj.   Jen tio c^i estas la sepa pas^o 
al la dua eldono oficiala.
...
(3) Se vi trovis eraron en la vortareto, au^ se vi volas kontakti 
   la kompilanton, turnu vin al la suba adreso:

   Notu, ke mi uzas "Shift-JIS"-kodaron por la japanlingva parto.

   2017.01.30

                           HIROTAKA Masaaki  <hirotk-m(c^e)nifty.com>
...
+---------------------------------------------------------------------+
       『実用エスペラント小辞典』（第１.８１版）　　　使用説明書　  
+---------------------------------------------------------------------+
     Praktika Esperanto-Japana Vortareto.   Ver 1.81
...
　今回の見出し４４１０４項目のうち，単純な見出し語は３８０２７語で，連
語・熟語が６０７７項目あります。今後は後者についても積極的に収録してい
こうと考えています。
...
==================
 収録語彙について
==================
　今回収録した見出しは合計４４１０４項目で，エスペラント・アカデミーオ
の公認語根４９５３語をすべて含んでいます。
　
...
に"-"［半角ダッシュ］がつくものは接頭辞・接尾辞として使われることを示
します。
...
※表記：字上符付きの文字は，c^, g^, h^, j^, s^, u^ のように代用表記を
　　　　しています。
　
...
（例）san/a 健康な
      ...
      re/san/ig/a 治療用の           mal/san/ig^/i 病気になる
      re/san/ig/ej/o 保養所          mal/san/ul/o 病人
      re/san/ig/il/o 治療薬          mal/san/ul/ej/o 病院
      re/san/ig^/i 病気がなおる      re/mal/san/ig^/o 病気の再発
      re/san/ig^/o 健康回復          san/eg/a, san/ul/o, ...
...
　　　　電子メール宛て先：hirotk-m(c^e)nifty.com 
　
...
====================
  pri la kapvortoj
====================
Tiu c^i eldono enhavas 44102 kapvortojn, kiuj estas ne nur 
radikvortoj, sed ankau^ derivaj^oj, kunmetaj^oj kaj vortokombinoj.  
G^i entenas c^iujn el la 4953 oficialaj radikoj de la Akademio de 
Esperanto.
...
konsistas el linioj finig^antaj per linifinilo(¥n).  Unu linio 
...
Literoj inter "［" kaj "］" [plurbajtaj rektaj krampoj sjis-816D, 
sjis-816E] indikas gramatikan informon de la kapvorto.
Literoj inter "【" kaj "】" [plurbajtaj konkavaj krampoj sjis-8179, 
...
====================
 oficialeco
====================
Mi markis per "{Ｏ}" c^iun oficialan radikon en baza formo registrita 
de la Akademio de Esperanto.
Mi markis per "{Ｂ}" c^iun vorton el la Baza Radikaro Oficiala (1974).
